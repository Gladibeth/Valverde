<section id="contacto" class="main-twoform">
  <div class="container-fluid">
    <div class="main-twoform__content">
      ...
      <div class="main-twoform__item">
        <form method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_31_" class="_form _form_31 _inline-form  _dark" novalidate>
          ...
          <div class="_form-content">
            ...
            <div class="main-contact__btnbox">
              <button id="_form_31_submit" class="btn_custom btn--medium btn--filledLight" type="submit">
                Enviar
              </button>
            </div>
